...
function createRectangularDomain_DN_jl(MyRectangularDomain::RectangularDomain, set_x_max::Float64, set_y_max::Float64, set_z_max::Float64, V_at_x_min::Float64, V_at_x_max::Float64, N_cells_x::Int)
...
function solvePoissonEquation_GPU_jl(myDomain::RectangularDomain)
    par1= myDomain.N
    par2 = myDomain.chagre_bin
    par3 = myDomain.V_first
    par4 = myDomain.V_last
    ...
    solvePoissonEquation_GPU(
    par1,par2,par3,par4,par5,par6,par7,par8)
end

function solvePoissonEquation_2Neumann_jl(myDomain::RectangularDomain,E1::Float64,E2::Float64,deltaX::Float64)
    par1= myDomain.N
    par2 = myDomain.chagre_bin
    par3 = E1
    par4 = E2
    ...
    solvePoissonEquation_2Neumann(
    par1,par2,par3,par4,par5,par6,par7,par8,par9)
end

function solvePoissonEquation_DN_jl(myDomain::RectangularDomain,E2::Float64,deltaX::Float64)
    par1= myDomain.N
    par2 = myDomain.chagre_bin
    par3 = myDomain.V_first
    par4 = E2
...
function boundaryConditionsRectangularNoWallLoss_GPU_jl(myParticle::Particle, myDomain::RectangularDomain)
    par1 = myParticle.xArray
    par2 = myParticle.yArray
    par3 = myParticle.zArray
    par4 = myParticle.VxArray
    ...
    return boundaryConditionsRectangularNoWallLoss_GPU(par1, par2, par3, par4, par5, par6, par7, par8, par9, par10, par11, par12, par13, par14,
    par15, par16, par17, par18, par19, par20, par21, par22, par23, par24, par25, par26, par27, par28, par29, par30, par31, par32)
end

function boundaryConditionsRectangularNoWallLoss_returndE_jl(myParticle::Particle, myDomain::RectangularDomain)
    par1 = myParticle.xArray
    par2 = myParticle.yArray
    par3 = myParticle.zArray
    par4 = myParticle.VxArray
    ...
    par33 = myDomain.electric_constant
    par34 = myDomain.Y_MAX*myDomain.Z_MAX
    
    return boundaryConditionsRectangularNoWallLoss_returndE(par1, par2, par3, par4, par5, par6, par7, par8, par9, par10, par11, par12, par13, par14,
    par15, par16, par17, par18, par19, par20, par21, par22, par23, par24, par25, par26, par27, par28, par29, par30, par31, par32,par33,par34)
end
...
function calculateNeededNumberOfCells_jl(myDomain::RectangularDomain)
    par1 = myDomain.electric_constant
    par2 = MyDomain.neArray
    par3 = MyDomain.CeArray
    par4 = MyDomain.N
    par5 = MyDomain.X_MAX
    par6 = MyDomain.Y_MAX

    calculateNeededNumberOfCells(par1, par2,par3,par4,par5,par6)
end

function anodeMassFlow_jl(myDomain::RectangularDomain, mass_flow_rate::Float64, dt::Float64)
    myDomain.neutral_mass_store[length(myDomain.neutral_mass_store)] += mass_flow_rate*dt;
end